package com.sysco.java_ui_automation.common;

public class Constants
{
    public static final String TEST_ENV = System.getProperty("test.env", "QA");
    public static final String TEST_RELEASE = System.getProperty("test.release", "Java_Based_Web_Ui_Automation_Assignment_Lakeesha");
